...
STAGES = {
    ...
    'Recording bundled sections': ('sections', .85, .86),
    'Building corridors': ('corridors', .93, .99),
    'Building corridor maps': ('corridors', .93, .99),
    'Building group graph': ('graph', .86, .89),
    'Sorting group candidates': ('sorting', .89, .90),
    'Calculating savings': ('savings', .90, .93),
